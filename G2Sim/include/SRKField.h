...
enum FieldClass{FIELDCLASS_UNIFORM,FIELDCLASS_GRADIENT,FIELDCLASS_DIPOLE,FIELDCLASS_OSCILLATING,FIELDCLASS_INTERPOLATION,FIELDCLASS_QUADRUPOLE,FIELDCLASS_SEXTUPOLE,FIELDCLASS_B,FIELDCLASS_E};
