...
//typedef boost::multiprecision::number<mp_backend, boost::multiprecision::et_off> SRKSpinFloat;
...
using SRKODEState= std::vector<SRKSpinFloat>;  //Presumes 10 entries: X,Y,Z,Vx,Vy,Vz,Mx,My,Mz,time
